...
@section('main')
  <section class="flex flex-col gap-4 container">
    <form action="{{ route('admin.makanan.update', $makanan->id) }}" method="POST" class="bg-white p-3 rounded-md">
      @csrf
      @method('PUT')
      <h1 class="text-lg font-semibold mb-6">Edit Makanan</h1>
      <div class="mb-6">
